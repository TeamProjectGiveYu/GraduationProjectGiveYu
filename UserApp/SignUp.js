...
export default function SignUp(props) {
  ...
  const [charity_identification, setcharity_identification] = useState('');
  const [charity_identification_error, setcharity_identification_error] = useState('');
  ...
  const [charity_info, setcharity_info] = useState('');
  const [charity_facebook, setcharity_facebook] = useState('');
  const [charity_instagram, setcharity_instagram] = useState('');
  const [facebook_error, setfacebook_error] = useState('');
  const [instagram_error, setinstagram_error] = useState('');

  const [charity_data, setcharity_data] = useState({});
  ...
  const Validation_Before_CharitySignUp = () => {
    ...
    // facebook Conditions
    if (charity_facebook.trim() == '') {
      setfacebook_error('الرجاء إدخال لينك الفيسبوك');
      errors++;
    }
    // else if (reg.test(charity_facebook.trim()) == false) {
    //   setfacebook_error('تأكد من إدخال لبنك الفيسبوك بشكل صحيح!');
    //   errors++;
    // } 
    else {
      setfacebook_error('');
    ...
    if (charity_instagram.trim() == '') {
      setinstagram_error('الرجاء إدخال لينك الانستجرام');
      errors++;
    }
    // else if (reg.test(charity_email.trim()) == false) {
    //   setinstagram_error('تأكد من إدخال لينك الانستاجرام بشكل صحيح!');
    //   errors++;
    // } 
    else {
      setinstagram_error('');
    ...
    // Confirm Pass Conditions
    if (
      charity_confirmPassword.trim() == '' &&
      charity_password.trim() != ''
    ) {
      setconfPasswor_error('الرجاء تأكيد كلمة المرور');
      errors++;
    } else if (
      charity_confirmPassword.trim() != charity_password
    ) {
    ...
    //Number Conditions
    if (charity_identification.trim() == '') {
      setcharity_identification_error('الرجاء إدخال رقم القيد ');
      errors++;
    } else {
      setcharity_identification_error('');
    }
                ...
                <View style={styles.containerOfTextInputs}>
                  ...
                  <View style={styles.containerOfEachTextInput}>
                    ...
                    <View style={styles.iconContainerStyle}>
                      <FontAwesome5 name="user-alt" color={loginIcons} size={22} />
                    </View>
                  </View>
              ...
              <View style={styles.pageContainer}>
                ...
                <View style={styles.containerOfTextInputs}>
                  ...
                  <View style={styles.containerOfEachTextInput}>
                    {/* Email TextInput */}
                    <TextInput
                      value={charity_facebook}
                      onChangeText={value => {
                        setcharity_facebook(value);
                      }}
                      style={styles.textInputStyle}
                      autoCorrect={false}
                      keyboardType="email-address"
                    ...
                    {/* Email Icon */}
                    <View style={styles.iconContainerStyle}>
                      <Fontisto name="facebook" color={loginIcons} size={25} />
                    </View>
                  </View>
                  ...
                  <View style={styles.containerOfEachTextInput}>
                    {/* Email TextInput */}
                    <TextInput
                      value={charity_instagram}
                      onChangeText={value => {
                        setcharity_instagram(value);
                      }}
                      style={styles.textInputStyle}
                      autoCorrect={false}
                      keyboardType="email-address"
                    ...
                    {/* Email Icon */}
                    <View style={styles.iconContainerStyle}>
                      <Entypo name="instagram" color={loginIcons} size={25} />
                    </View>
                  </View>
                  ...
                  <View style={styles.containerOfEachTextInput}>
                    ...
                    <TextInput
                      multiline={true}
                      value={charity_identification}
                      onChangeText={value => {
                        setcharity_identification(value);
                      }}
                      style={styles.textInputStyle}
                      autoCorrect={false}
