...
class FullCasesDetails extends React.Component {
  constructor(props) {
    ...
    this.state = {
      savedstate: false,
      caseDetails: this.props.route.params.caseDetails,
      icon_name: 'create-outline',
      // index:caseDetails.case_id
      edit_case_index: '',
      edit_case_name: '',
  ...
  // inputs() {
  //   let arr = this.state.caseDetails;
  //   this.state.edit_case_name = arr.case_name;
  //   this.state.edit_case_identfication = arr.case_identfication;
  //   this.state.edit_case_age = arr.case_age;
  //   this.state.edit_case_needs = arr.case_needs;
  //   this.state.edit_case_explaination = arr.case_explaination;
  //   this.state.edit_case_category = arr.case_category;
  //   this.setState({
  //     caseDetails: arr,
  //   });
  // }
          ...
          <View
            ...
            <TouchableOpacity
              onPress={() => {
                ...
                //   fullEdit: this.state.caseDetails,
                // });
            ...
            <View style={{alignSelf: 'center'}}>
              <Text
                ...
                {this.state.caseDetails.case_name}
              </Text>
            </View>
        ...
        <View
          ...
          <ScrollView>
            ...
            <Text
              ...
              {this.state.caseDetails.case_explaination}
            </Text>
            ...
            <Text
              ...
              <Text
                ...
                {this.state.caseDetails.case_age} سنه
              </Text>
            </Text>
            <Text
              style={{
              ...
              <Text
                ...
                {this.state.caseDetails.case_identfication}
              </Text>
            </Text>
            <Text
              style={{
              ...
              <Text
                ...
                {this.state.caseDetails.case_category}
              </Text>
            </Text>
            <Text
              style={{
              ...
              <Text
                ...
                {this.state.caseDetails.case_needs}
              </Text>
            </Text>
          </ScrollView>
        </View>
          ...
          <>
            ...
            <KeyboardAvoidingView style={styles.bodyContainer}>
              <ScrollView>
                ...
                <View style={styles.containerOfEachTxtInput}>
                  <Hoshi
                    value={this.state.edit_case_category}
                    onChangeText={value => {
                      this.setState({edit_case_category: value});
                    }}
                    label={' الفئه'}
                    labelStyle={{
                      fontSize: width * 0.05,
